...
def measure_efficiency(model, device, input_shape=(1, 100, 42), warmup=10, iters=100):
    """
...
# ------------------------------------------------------------------------------
def main():
    X_TEST_PATH = "/content/drive/MyDrive/Colab Notebooks/ASF/RealWorld2016/X_test.npy"
    Y_TEST_PATH = "/content/drive/MyDrive/Colab Notebooks/ASF/RealWorld2016/y_test.npy"
    MODEL_PATH = '/content/drive/MyDrive/Colab Notebooks/ASF/RealWorld2016/RealWorld2016_ASF.pth'
