...
from model_utils import RealWorldDataset, ASFDCLClassifier, seed_worker
try:
...
def plot_classification_results(y_true, y_pred, save_path=None):
    ...
    ax = sns.heatmap(cm, annot=True, fmt='.2f', cmap='Blues', square=True,
                annot_kws={"size": 33}, cbar_kws={"shrink": 0.7},
...
def measure_efficiency(model, device, input_shape=(1, 100, 6), warmup=10, iters=100):
    """
...
# ------------------------------------------------------------------------------
def main():
    X_TEST_PATH = "/content/drive/MyDrive/Colab Notebooks/ASF/RealWorld2016-ChestOnly/X_test.npy"
    Y_TEST_PATH = "/content/drive/MyDrive/Colab Notebooks/ASF/RealWorld2016-ChestOnly/y_test.npy"
    MODEL_PATH = '/content/drive/MyDrive/Colab Notebooks/ASF/RealWorld2016-ChestOnly/RealWorld2016-ChestOnly_ASF.pth'
    ...
    test_dataset = RealWorldDataset(X_TEST_PATH, Y_TEST_PATH)
    ...
    metrics = measure_efficiency(model, DEVICE)
