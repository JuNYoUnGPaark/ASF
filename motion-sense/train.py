...
from model_utils import (set_seed, seed_worker, MotionSenseDataset,
...
def main():
    ...
    SAVE_PATH = '/content/drive/MyDrive/Colab Notebooks/ASF/motion-sense/motion-sense_ASF.pth'
    ...
    full_dataset = MotionSenseDataset(DATA_PATH, window_size=128, step_size=64, normalize=False)
