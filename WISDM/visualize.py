...
from model_utils import WISDMDataset, ASFDCLClassifier, seed_worker
try:
...
def main():
    ...
    MODEL_PATH = '/content/drive/MyDrive/Colab Notebooks/ASF/WISDM/WISDM_ASF.pth'
    ...
    metrics = measure_efficiency(model, DEVICE, input_shape=(1, 80, 3))
