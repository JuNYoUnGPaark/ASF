...
from model_utils import (set_seed, seed_worker, PAMAP2Dataset,
...
def main():
    ...
    SAVE_PATH = '/content/drive/MyDrive/Colab Notebooks/ASF/PAMAP2/PAMAP2_ASF.pth'
    ...
    full_dataset = PAMAP2Dataset(DATA_PATH)

    train_size = int(0.8 * len(full_dataset))
    test_size = len(full_dataset) - train_size

    g_split = torch.Generator().manual_seed(SEED)
    train_dataset, test_dataset = random_split(full_dataset, [train_size, test_size], generator=g_split)
