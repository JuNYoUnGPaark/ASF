...
from model_utils import PAMAP2Dataset, ASFDCLClassifier, seed_worker
try:
...
def measure_efficiency(model, device, input_shape=(1, 128, 36), warmup=10, iters=100):
    """
...
def main():
    ...
    MODEL_PATH = '/content/drive/MyDrive/Colab Notebooks/ASF/PAMAP2/PAMAP2_ASF.pth'
    ...
    model = ASFDCLClassifier().to(DEVICE)
    ...
    metrics = measure_efficiency(model, DEVICE, input_shape=(1, 128, 36))
