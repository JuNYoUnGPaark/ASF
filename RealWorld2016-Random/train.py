...
def main():
    ...
    DATA_DIR = "/content/drive/MyDrive/Colab Notebooks/ASF/RealWorld2016"
    SAVE_PATH = '/content/drive/MyDrive/Colab Notebooks/ASF/RealWorld2016/RealWorld2016_ASF.pth'
