...
from model_utils import UniMiBARDataset, ASFDCLClassifier, seed_worker
try:
...
ACTIVITY_LABELS = [
    ...
    "Standing up from laying",  # 1
    "Walking",       # 2
    "Running",       # 3
    "Going upstairs",      # 4
    "Jumping",       # 5
    "Going downstairs",    # 6
    "Lying down from standing",   # 7
    "Sitting down"    # 8
]
...
def measure_efficiency(model, device, input_shape=(1, 151, 3), warmup=10, iters=100):
    """
...
def main():
    ...
    MODEL_PATH = '/content/drive/MyDrive/Colab Notebooks/ASF/UniMiB-SHAR/UniMiB-SHAR_ASF.pth'
    ...
    test_dataset = UniMiBARDataset(DATA_PATH, split='test')
