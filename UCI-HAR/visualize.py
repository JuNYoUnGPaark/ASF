...
from model_utils import UCIHARDataset, ASFDCLClassifier, seed_worker
try:
...
def measure_efficiency(model, device, input_shape=(1, 128, 9), warmup=10, iters=100):
    """
...
def main():
    ...
    MODEL_PATH = '/content/drive/MyDrive/Colab Notebooks/ASF/UCI-HAR/UCI-HAR_ASF.pth'
