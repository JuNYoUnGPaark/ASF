...
from model_utils import MHEALTHDataset, ASFDCLClassifier, seed_worker
try:
...
def measure_efficiency(model, device, input_shape=(1, 128, 23), warmup=10, iters=100):
    """
...
def main():
    ...
    MODEL_PATH = '/content/drive/MyDrive/Colab Notebooks/ASF/MHEALTH/MHEALTH_ASF.pth'
